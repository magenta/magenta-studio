...
,
		"classnamespace" : "box",
		"rect" : [ 34.0, 87.0, 842.0, 737.0 ],
		"openrect" : [ 0.0, 0.0, 659.0, 169.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 850.0, 657.0, 175.0, 22.0 ],
					"text" : "url http://localhost:3333/drumify"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 626.0, 657.0, 183.0, 22.0 ],
					"text" : "url http://localhost:3333/generate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 422.0, 657.0, 173.0, 22.0 ],
					"text" : "url http://localhost:3333/groove"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 214.0, 657.0, 192.0, 22.0 ],
					"text" : "url http://localhost:3333/interpolate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 657.0, 181.0, 22.0 ],
					"text" : "url http://localhost:3333/continue"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 850.0, 622.0, 100.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 123.0, 140.0, 132.0, 20.0 ],
					"rounded" : 2.0,
					"text" : "DRUMIFY",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 630.0, 622.0, 100.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 123.0, 109.0, 132.0, 20.0 ],
					"rounded" : 2.0,
					"text" : "GENERATE",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"texton" : "GENERATE",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 417.0, 622.0, 100.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 123.0, 77.0, 132.0, 20.0 ],
					"rounded" : 2.0,
					"text" : "GROOVE",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"texton" : "GROOVE",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 210.0, 626.0, 100.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 123.0, 43.0, 132.0, 20.0 ],
					"rounded" : 2.0,
					"text" : "INTERPOLATE",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"texton" : "INTERPOLATE",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 20.0, 622.0, 100.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 123.0, 11.0, 132.0, 20.0 ],
					"rounded" : 2.0,
					"text" : "CONTINUE",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"texton" : "CONTINUE",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 704.0, 775.0, 73.0, 22.0 ],
					"text" : "route server"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 704.0, 737.0, 71.0, 22.0 ],
					"text" : "r from-node"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 704.0, 809.0, 181.0, 22.0 ],
					"text" : "url http://localhost:3333/continue"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 27.0, 755.0, 322.0, 546.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 270.0, 0.0, 389.0, 169.0 ],
					"rendermode" : 0,
					"url" : "http://localhost:3333/continue"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 696.0, 265.0, 400.0, 220.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 322.0, 183.0, 63.0, 22.0 ],
					"text" : "script stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 327.0, 134.0, 209.0, 22.0 ],
					"text" : "script start NODE_ENV=development"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 661.0, 1.75, 5.0, 170.5 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 169.0, 665.0, 5.0 ]
				}
